              ...
              <form className='mt-8 flex flex-col gap-4'>
                ...
                <div className='flex gap-6'>
                  <div className='flex flex-col gap-2'>
                    ...
                    <div className='flex gap-1 grid grid-cols-4'>
                      <button
                        title='Domingo'
                  ...
                  <div className='flex flex-col gap-2 flex-1'>
                    ...
                    <div>
                      <div className='grid grid-cols-2 gap-2'>
                        <Input id='timeStart' type="time" placeholder='De' />
                        <Input id='timeEnd' type="time" placeholder='De' />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <footer className='mt-4 flex justify-end gap-4'>
                  <Dialog.Close className='bg-zinc-500 px-5 h-12 rounded-md font- hover:bg-zinc-600'>
                    Cancelar
                  </Dialog.Close>
                  <button
                    type='submit'
